...
\def\primeiroavaliadorafiliacao{							% instituição do primeiro avaliador
	Universidade TAL \\ Instituto TAL
}           		
...
\include{sections/folhadeaprovacao}
...
\include{sections/fundamentacao}
\include{sections/metodologia}
\include{sections/desenvolvimento}
